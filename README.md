...
- **Аналитика** — три графика на выбранную роль (chart.js): исходящий
  урон с разбивкой melee / spell / урон петов; входящий с разбивкой
  получено / поглощено защитами; попадания/промахи/уклоны/криты по
  раундам. Над графиками — totals-strip (отдал / принял / поглотил /
  попал % / крит % / уклон). Селектор роли переключает все три
  графика и тоталы.
...
Скриншоты и подробная прогулка по UI — в [docs/DEMO.md](docs/DEMO.md).
